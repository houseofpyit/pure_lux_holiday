...
class Award(UUIDMixin, TimestampMixin, Base):
    ...
    organization: Mapped[Optional[str]] = mapped_column(String(255), default=None, nullable=True)
    award_date: Mapped[Optional[str]] = mapped_column(String(50), default=None, nullable=True)
