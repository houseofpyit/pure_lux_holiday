/**
 * PackagesCtaCms — Luxury Packages Page › CTA Section
 * Reuses global CTA (useCTA / useUpdateCTA). Same pattern as Experiences/Destinations.
 */
...
export default function PackagesCtaCms() {
  ...
  const updateMutation = useUpdateCTA({
    onSuccess: () => { save(extForm); toast({ title: 'CTA section saved' }); },
  ...
  const handleSave = () => {
    ...
    save(extForm); updateMutation.mutate(form);
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          <div className="bg-white border border-border rounded-xl p-6">
            ...
            <MediaUploader module="packages" section="cta" accept="image/*" maxSizeMB={10}
